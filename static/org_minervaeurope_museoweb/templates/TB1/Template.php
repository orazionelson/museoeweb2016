...
class Template extends org_minervaeurope_museoweb_CustomTemplate
{
	...
	function processImages()
	{
		...
		if (intval($this->_template['imageLogo']) > 0)
		{
			...
			$this->_content['imageLogo'] = org_glizy_helpers_Media::getImageById($this->_template['imageLogo'], false, '');
		}
		else
		{
			$this->_content['imageLogoUrl'] = 'static/org_minervaeurope_museoweb/templates/TB1/assets/images/logoMibac.gif';
			$this->_content['imageLogo'] = '<img src="static/org_minervaeurope_museoweb/templates/TB1/assets/images/logoMibac.gif" alt="Ministero per i Beni e le Attivit&agrave; Culturali" title="Ministero per i Beni e le Attivit&agrave; Culturali"/>';
		}
		...
		$this->linkLogo=$this->_template['linkLogo'];
	...
	function render()
	{
		...
		$this->_owner->addOutputCode($this->linkLogo,  'linkLogo');
		//$this->_owner->addOutputCode('<h1>'.$this->_template['title'].'</h1>', 'logo');
