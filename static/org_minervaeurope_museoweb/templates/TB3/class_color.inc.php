...
class color {
	...
	function whiteOpacity($val)
	{
		$val = 1-$val;
		$this->r = bound_value($this->r+((255-$this->r)*$val),0,255);
		$this->g = bound_value($this->g+((255-$this->g)*$val),0,255);
		$this->b = bound_value($this->b+((255-$this->b)*$val),0,255);
	}
}
