...
class Template extends org_minervaeurope_museoweb_CustomTemplate
{
	...
	function processImages()
	{
		...
		{
			$this->_content['imageLogoUrl'] = 'static/org_minervaeurope_museoweb/templates/TB6/assets/images/logoMibac.gif';
			$this->_content['imageLogo'] = '<img src="static/org_minervaeurope_museoweb/templates/TB6/assets/images/logoMibac.gif" alt="Ministero per i Beni e le Attivit&agrave; Culturali" title="Ministero per i Beni e le Attivit&agrave; Culturali" style="margin-top: 25px; margin-left: 40px;"/>';
		}
